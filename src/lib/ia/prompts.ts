...
- Destaque não conformidades em **negrito**
- Mantenha formatação profissional (markdown)
...
- memorial: string (memorial descritivo completo em markdown)
...
IMPORTANTE: Retorne APENAS um JSON válido, sem markdown code blocks, sem explicações adicionais.`;
}
...
- detalhamento: string (texto completo do orçamento em markdown)
...
- memorial_calculo: string (texto completo em markdown)
...
- objetivo: string
- metodologia: string
- analise: string (análise técnica completa em markdown)
- conclusoes: string
- recomendacoes: string
- laudo_completo: string (texto completo formatado em markdown)
...
- observacoes: string
- relatorio_completo: string (texto completo em markdown)
