...
- ✅ Modelo padrão: `claude-sonnet-4` (com fallback automático)
...
| Modelo | `sonar` | `claude-sonnet-4` (fallback: `claude-sonnet-4-20250514`, `claude-3-5-sonnet-latest`, `claude-3-5-haiku-latest`) |
